...
# Run d4j mutation2
(defects4j mutation2 -t testClass::testMethod -s /home/people/12309511/test_suites/fixed_suites/$project/$gen/$seed/${project}-${version}-${gen}.${seed}.tar.bz2 && echo "${project}-${version}-${gen}.${seed}.tar.bz2" >> /home/people/12309511/logging/6_major_mut_analysis/redo_success_mut_suites.log) || echo "${project}-${version}-${gen}.${seed}.tar.bz2" >> /home/people/12309511/logging/6_major_mut_analysis/redo_failed_mut_suites.log
