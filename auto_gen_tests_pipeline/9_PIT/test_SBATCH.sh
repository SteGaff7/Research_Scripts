...
log_dir="/home/people/12309511/scratch/test_logging/${project}"
mkdir --parents $log_dir
suites="/home/people/12309511/test_suites/fixed_suites/${project}/${gen}/${seed}"
out_dir="/home/people/12309511/scratch/tmp_pit_out"
...
# Run PIT
(run_pit.pl -p ${project} -o ${out} -d ${suites} -v ${version}) || echo "${project}-${version}-${gen}-${seed}" >> "${log_dir}/${project}_failed_pit_suites.log"
